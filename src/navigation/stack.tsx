...
export const RootStack = () => {
  return (
    <Stack.Navigator
      ...
      <Stack.Screen
        name={screenNames.COURSE_LISTING_SCREEN}
        component={CourseListingScreen}
      />
      <Stack.Screen
        name={screenNames.COURSE_DETAIL_SCREEN}
      ...
      />
      <Stack.Screen
        name={screenNames.CATEGORIES_SCREEN}
        component={CategoriesScreen}
      />
      <Stack.Screen
        name={screenNames.POPULAR_COURSES_SCREEN}
      ...
      />
      <Stack.Screen
        name={screenNames.INSTRUCTOR_PROFILE_SCREEN}
